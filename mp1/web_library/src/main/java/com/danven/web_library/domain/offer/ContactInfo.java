...
public class ContactInfo implements Serializable {
    ...
    private ContactInfo(Builder builder) {
        ...
        validateTelephoneNumber(builder.telephoneNumber);
        validateSocialMediaLink(builder.socialMediaLink);
    ...
    public static class Builder {
        ...
        public Builder setSocialMediaLink(String socialMediaLink) {
            this.socialMediaLink = socialMediaLink;
            return this;
        }
