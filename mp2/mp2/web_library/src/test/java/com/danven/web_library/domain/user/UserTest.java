...
public class UserTest {
    ...
    private static final UserAccount VALID_USER_ACCOUNT_1 = Factory
            .getUserAccountWithEmailAndDefaultParameters("danven2018@mail.com");

    private static final UserAccount VALID_USER_ACCOUNT_2 = Factory
            .getUserAccountWithEmailAndDefaultParameters("danven2018@mail.en");
    ...
    public void testCalculateAverageAgeOfUsers(){
        ...
        User userSecond = new User.UserBuilder()
                ...
                .setUserAccount(VALID_USER_ACCOUNT_2)
                .build();
