package com.danven.web_library.domain.address;
...
public class Address implements Serializable {
    ...
    public void setUser(User user) {
        if (this.user != user) {
            if (this.user != null) {
                this.user.removeAddress(this.postalCode);
            }
            this.user = user;
            if (user != null) {
    ...
    public void setPostalCode(String newPostalCode) {
        ...
        if (!Objects.equals(this.postalCode, newPostalCode)) {
            String oldPostalCode = this.postalCode;
            this.postalCode = newPostalCode;
            if (this.user != null) {
                this.user.updateAddressKey(oldPostalCode, this);
            }
        }
    }
    ...
    private static void validatePostalCode(String postalCode) {
        ...
        if( records.stream().anyMatch(address -> address.getPostalCode().equals(postalCode))){
            throw new ValidationException("Postal code should be unique");
        }
